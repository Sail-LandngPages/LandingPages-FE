...
const GameHero = () => {
    return(
        <div className="w-full p-[130px] bg-[#111827] bg-cover bg-center relative flex justify-center items-center" style={{ backgroundImage: `url(${backgroundimage})` }}>
            <div className="w-[1400px] h-[600px] flex  items-center justify-around">
                <div>
                    ...
                    <div className="w-[600px] h-[150px] border-l-[4px] border-[#61B8A8] pl-[20px] mb-[40px] flex justify-center items-center">
                        <p className="text-gray-400 text-[20px] font-[450]">Want to design your own video games, bring characters to life, and create experiences that millions can play? The SAIL Game Development Learning Track is your shortcut to becoming a game dev pro!</p>
                    </div>
                    <div className="flex justify-center items-center gap-7">
                        <button className="w-[250px] h-[45px] font-[orbitron] font-bold text-black text-[15px] bg-[#FBAD04] rounded-lg shadow-[bottom] cursor-pointer hover:bg-[#61B8A8] transition-all duration-300 border-b-4 border-[#926b18]">START YOUR QUEST HERE</button>
                        <button className="w-[250px] h-[45px] font-medium text-white text-[15px] font-[orbitron] border-[#61B8A8] border-[3px] rounded-lg cursor-pointer hover:border-[#61B8A8] transition-all duration-300">VIEW SKILL TREE</button>
                    </div>
                </div>
