...
const DesignCard = ({ icon: Icon, title, description, iconColor }) => (
  <div className="relative group flex flex-col justify-evenly items-center w-[322px] h-[285.33px] lg:w-[220px] lg:h-[380px] p-6 rounded-lg font-inter shadow-sm border border-gray-100 hover:shadow-lg transition-shadow ">
