...
const GenFoot = () => {
  return (
    <section className=" relative bg-[linear-gradient(to_bottom_right,_#4F46E5_0%,_#2563EB_50%,_#0891B2_100%)] w-full p-8 flex flex-col items-center justify-center font-inter text-white text-center overflow-hidden">
     <div className="flex justify-evenly w-full absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
             {Array.from({ length: 5 }).map((_, i) => (
               <img key={i} src={divider} alt="Decorative divider" />
             ))}
           </div>
        ...
        <div className="flex flex-col items-center mt-4 space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mt-4 px-4">
            <IconProps
              ...
              className="border-none text-white py-1 px-3"
            />
            <IconProps
              icon={<LiaTrophySolid />}
