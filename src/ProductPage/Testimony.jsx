...
const Testimony = () => {
  ...
  return (
    <div>
      ...
      {/* Floating badge */}
      <span className="absolute left-1/2 transform -translate-x-2/4 -top-2 -rotate-12 bg-teal-500 text-white text-xs px-3 py-1 rounded-full shadow-md">
        Testimonial
      </span>
            ...
            <div className="w-full md:w-3/5 p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center justify-between mt-6">
                <div className="flex space-x-2">
                  <div className="flex items-center justify-between w-full lg:max-w-4xl mx-auto p-6 ">
                    {/* Left section */}
                    ...
                    <div className="flex lg:space-x-4 lg:ml-6 space-x-2 ">
