...
const HeroSoftdev = () => {
  return (
    <div>
      <main  className="bg-[#12245f] text-white px-[46px] py-[33px]  ">

          <div className="container flex flex-col lg:flex-row justify-center items-center gap-10 px-[10px] py-[8px]">
                
              <div className="left">
                      
              <div className='w-[231.33px] h-[29.33px] mt-2 mb-10 py-2 px-4 bg-[rgba(251,180,4,0.2)] border-[0.2px] border-[#FBB404] rounded-full bg-[#FBB404] flex items-center gap-2 mb-4'>
                <img src={logo1} alt=""  />
              ...
              <div className="">
              <p className="inline-block text-[20px] mt-2">Launch your dream with Us</p>
              <div className="bg-[#f6784c] w-[65px] h-[2px] mx-44 mb-2 rounded-full transform -translate-y-[1px]"></div>
            </div>


              <p className='w-[447px] h-[178] mb-4 text-[15px] bg-[#0e1e4c] pt-[15.34px] pb-[15.91px] pr-[16px] pl-[16px] border-l-[4px] border-[#26dacb] rounded-[12px] '>The sail sotfaware Development Learning Track equips aspiring 
